(function(){
 ...
 function makeLine(id,d){var c=el(id);if(!c)return;new Chart(c,{type:'line',
   ...
   options:{responsive:true,maintainAspectRatio:false,interaction:{mode:'index',intersect:false},
     scales:{x:{grid:{display:false}},y:{type:d.log?'logarithmic':'linear',title:{display:true,text:d.ytitle},ticks:{callback:function(v){return fmtK(v);}}}},
 ...
 function makeDiverging(id,d){var c=el(id);if(!c)return;new Chart(c,{type:'bar',
   ...
   options:{indexAxis:'y',responsive:true,maintainAspectRatio:false,
     scales:{x:{title:{display:true,text:d.xtitle},grid:{color:function(ctx){return ctx.tick&&ctx.tick.value===0?'#888':'#eee';}}},y:{ticks:{font:{size:11},autoSkip:false}}},
